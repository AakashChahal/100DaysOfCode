...
print(logo)
print(head)
play_or_not = input("Type play to start playing: ").lower()
...
def play():
    global choice1, choice2, score
    while(play_or_not == "play"):
        os.system("cls")
        print(logo)
        ...
        if user_choice == "a" and choice1["follower_count"] > choice2["follower_count"]:
            ...
            score += 1
        elif user_choice == "b" and choice1["follower_count"] < choice2["follower_count"]:
            choice1, choice2 = choice2, random.choice(data)
            score += 1
        else:
            os.system("cls")
...
if play_or_not == "play":
    ...
    print("Okay game stopped from loading.")
